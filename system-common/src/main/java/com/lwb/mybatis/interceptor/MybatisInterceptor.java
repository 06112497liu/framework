 ...
 * mybatis处理sql日志拦截器
 * <p>
 * 拦截sql，将sql的参数替换为真实参数，提高测试定位问题效率 注：只拦截了update和query方法，insert和delete方法最终调用的是update方法
 *
 * @author LiYong
 * @date 2018/06/13
 */
...
public class MybatisInterceptor implements Interceptor {
    ...
    private static Logger logger = LoggerFactory.getLogger(MybatisInterceptor.class.getName());
